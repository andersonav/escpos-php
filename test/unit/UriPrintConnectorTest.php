<?php
use Alves\Escpos\PrintConnectors\UriPrintConnector;
...
class UriPrintConnectorTest extends PHPUnit\Framework\TestCase
{
    public function testFile()
    {
        ...
        $this -> assertEquals('Alves\Escpos\PrintConnectors\FilePrintConnector', get_class($connector));
        unlink($filename);
    }
    ...
    public function testSmb()
    {
        ...
        $this -> assertEquals('Alves\Escpos\PrintConnectors\WindowsPrintConnector', get_class($connector));
